...
let Referals = {
  ...
  getAccountForTrx: 'SELECT m.address,f.quantity,f.insert_time,f.remain_month,f.account_id,m.passphrase,m.publickey FROM migrated_etps_users m INNER JOIN frozen2 f ON (m.id = f.account_id) order by f.account_id asc',
